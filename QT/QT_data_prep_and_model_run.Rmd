...
##noticed summary(out_rnd_eff) throws **WARNING** Rhat values indicate convergence failure. 
##inspected rhats and noticed one parameter (R.ad[2]) had rhat>1.1, the rest all looked good
##increased iterations and did not get rhat for R.ad[2] <1.1
##R.ad[2] is not used in averages of R.ad:
#	 mean_r3_pre <- mean(R.ad[3:15])
#	 mean_r3_post <- mean(R.ad[16:21])
##This is not a concern for this analysis and its results, all other params look good

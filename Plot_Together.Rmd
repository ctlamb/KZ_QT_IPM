...
##ABUNDANCE FIT
```{r Plot results-abundance fit, fig.height=5, fig.width=9, message=FALSE, warning=FALSE, results='hide'}
fit_df <- res_df%>%
...
```{r Plot results-vital rates vs raw data, fig.height=5, fig.width=9, results='hide', message=FALSE, warning=FALSE}
...
##WOLF EFFECT
```{r wolf, results='hide',fig.height=5, fig.width=9, message=FALSE, warning=FALSE}
...
##Wolf vs Pen effect
```{r Wolf vs Pen effect, fig.height=5, fig.width=7,results='hide', message=FALSE, warning=FALSE}
S <- ggs(kz$samples)%>%
